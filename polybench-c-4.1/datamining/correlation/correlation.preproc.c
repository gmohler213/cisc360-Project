...
# 1 "./datamining/correlation/correlation.h" 1
# 5 "correlation.c" 2
...
int main(int argc, char** argv)
{
  ...
  double (*corr)[m + 0][m + 0]; corr = (double(*)[m + 0][m + 0])polybench_alloc_data ((m + 0) * (m + 0), sizeof(double));;
  double (*mean)[m + 0]; mean = (double(*)[m + 0])polybench_alloc_data (m + 0, sizeof(double));;
  double (*stddev)[m + 0]; stddev = (double(*)[m + 0])polybench_alloc_data (m + 0, sizeof(double));;
