...
int main(int argc, char** argv)
{
  ...
  float alpha;
  float (*imgIn)[w + 0][h + 0]; imgIn = (float(*)[w + 0][h + 0])polybench_alloc_data ((w + 0) * (h + 0), sizeof(float));;
  float (*imgOut)[w + 0][h + 0]; imgOut = (float(*)[w + 0][h + 0])polybench_alloc_data ((w + 0) * (h + 0), sizeof(float));;
  float (*y1)[w + 0][h + 0]; y1 = (float(*)[w + 0][h + 0])polybench_alloc_data ((w + 0) * (h + 0), sizeof(float));;
  float (*y2)[w + 0][h + 0]; y2 = (float(*)[w + 0][h + 0])polybench_alloc_data ((w + 0) * (h + 0), sizeof(float));;
