...
int main(int argc, char** argv)
{
  ...
  double (*s)[m + 0]; s = (double(*)[m + 0])polybench_alloc_data (m + 0, sizeof(double));;
  double (*q)[n + 0]; q = (double(*)[n + 0])polybench_alloc_data (n + 0, sizeof(double));;
  double (*p)[m + 0]; p = (double(*)[m + 0])polybench_alloc_data (m + 0, sizeof(double));;
